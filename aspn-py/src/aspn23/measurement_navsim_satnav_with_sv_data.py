...
from .type_navsim_satnav_obs import TypeNavsimSatnavObs
from .type_navsim_satnav_sv_data import TypeNavsimSatnavSvData
from .type_satnav_time import TypeSatnavTime
from .type_timestamp import TypeTimestamp


@dataclass
class MeasurementNavsimSatnavWithSvData(AspnBase):
    """
