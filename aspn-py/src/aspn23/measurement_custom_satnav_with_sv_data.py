...
from .type_custom_satnav_obs import TypeCustomSatnavObs
from .type_custom_satnav_sv_data import TypeCustomSatnavSvData
from .type_satnav_time import TypeSatnavTime
from .type_timestamp import TypeTimestamp


@dataclass
class MeasurementCustomSatnavWithSvData(AspnBase):
    """
    ...
    sv_data - List[TypeSatnavSvData]:
            Array of satellite position, velocity, and clock information. These line up
            precisely with the obs, such that sv_data[N] is the satellite information for
            observations obs[N] for any valid N.
    ...
    receiver_clock_time: TypeSatnavTime
    num_signal_types: int
    obs: List[TypeCustomSatnavObs]
    sv_data: List[TypeCustomSatnavSvData]
    integrity: List[TypeIntegrity]
