...
from .type_satnav_signal_descriptor import TypeSatnavSignalDescriptor
...
class TypeSatnavObs:
    ...
    satellite_system - TypeSatnavSatelliteSystem:
            Enumerated field which describes the Satellite System that generated the
            observations.

    signal_descriptor - TypeSatnavSignalDescriptor:
