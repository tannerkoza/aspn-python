...
class MeasurementMagneticFieldMagnitudeErrorModel(Enum):
    """
...
@dataclass
class MeasurementMagneticFieldMagnitude(AspnBase):
    """
    ...
    error_model - MeasurementMagneticFieldMagnitudeErrorModel:
