...
class metadata_GPS_Lnav_ephemeris(object):
    """
    LNAV Ephemeris describing GPS satellite locations. Definitions and usage are
    covered in ICD-GPS-200L, Section 20.3.3.4 and following.
    """

    __slots__ = [
        "icd_metadata_GPS_Lnav_ephemeris",
        "info",
        "time_of_validity",
        "week_number",
        "prn",
    ...
    def _get_hash_recursive(parents):
        if metadata_GPS_Lnav_ephemeris in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if metadata_GPS_Lnav_ephemeris._packed_fingerprint is None:
            metadata_GPS_Lnav_ephemeris._packed_fingerprint = struct.pack(
                ">Q", metadata_GPS_Lnav_ephemeris._get_hash_recursive([])
            )
    ...
    def get_hash(self):
        ...
        return struct.unpack(
            ">Q", metadata_GPS_Lnav_ephemeris._get_packed_fingerprint()
        )[0]
