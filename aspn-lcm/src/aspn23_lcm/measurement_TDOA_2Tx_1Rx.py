...
class measurement_TDOA_2Tx_1Rx(object):
    ...
    __slots__ = [
        "icd_measurement_TDOA_2Tx_1Rx",
        "header",
        "time_of_validity",
        "tx1_position_and_covariance",
        "tx2_position_and_covariance",
        "obs",
        "variance",
        "error_model",
    ...
    def __init__(self):
        ...
        self.obs = 0.0
        """
        Description: Time difference of arrival (in meters). Time difference of Tx1 signal's arrival time minus Tx2 signal's arrival time at the sensor. Positive obs indicates Tx1 arrived later than Tx2
        Units: m
        LCM Type: double
        """
    ...
    def _encode_one(self, buf):
        ...
        assert (
            self.tx1_position_and_covariance._get_packed_fingerprint()
            == aspn23_lcm.type_remote_point._get_packed_fingerprint()
        )
        self.tx1_position_and_covariance._encode_one(buf)
        assert (
            self.tx2_position_and_covariance._get_packed_fingerprint()
            == aspn23_lcm.type_remote_point._get_packed_fingerprint()
        )
    ...
    def _get_hash_recursive(parents):
        if measurement_TDOA_2Tx_1Rx in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if measurement_TDOA_2Tx_1Rx._packed_fingerprint is None:
            measurement_TDOA_2Tx_1Rx._packed_fingerprint = struct.pack(
                ">Q", measurement_TDOA_2Tx_1Rx._get_hash_recursive([])
            )
        return measurement_TDOA_2Tx_1Rx._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", measurement_TDOA_2Tx_1Rx._get_packed_fingerprint())[
            0
        ]
