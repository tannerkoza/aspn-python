...
class measurement_barometer(object):
    ...
    def _decode_one(buf):
        ...
        self.pressure, self.variance, self.error_model, self.num_error_model_params = (
    ...
    def _get_hash_recursive(parents):
        if measurement_barometer in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if measurement_barometer._packed_fingerprint is None:
            measurement_barometer._packed_fingerprint = struct.pack(
                ">Q", measurement_barometer._get_hash_recursive([])
            )
