...
class measurement_magnetic_field(object):
    """
    Vector magnetic field. Represents the magnetic field strength along sensor x, y,
    and z axes as defined in mounting. May represent 1-D, 2-D, or 3-D measurement
    """

    __slots__ = [
        "icd_measurement_magnetic_field",
        "header",
        "time_of_validity",
        "num_meas",
        "x_field_strength",
    ...
    def _encode_one(self, buf):
        ...
        buf.write(
            struct.pack(
                ">hddd",
                self.num_meas,
                self.x_field_strength,
                self.y_field_strength,
                self.z_field_strength,
            )
        )
    ...
    def _decode_one(buf):
        ...
        (
            ...
            self.y_field_strength,
            self.z_field_strength,
        ) = struct.unpack(">hddd", buf.read(26))
        self.covariance = []
        for i0 in range(self.num_meas):
    ...
    def _get_hash_recursive(parents):
        if measurement_magnetic_field in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if measurement_magnetic_field._packed_fingerprint is None:
            measurement_magnetic_field._packed_fingerprint = struct.pack(
                ">Q", measurement_magnetic_field._get_hash_recursive([])
            )
    ...
    def get_hash(self):
        ...
        return struct.unpack(
            ">Q", measurement_magnetic_field._get_packed_fingerprint()
        )[0]
