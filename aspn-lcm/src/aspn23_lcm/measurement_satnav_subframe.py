...
class measurement_satnav_subframe(object):
    ...
    __slots__ = [
        "icd_measurement_satnav_subframe",
        "header",
        "time_of_validity",
        "gnss_message_id",
        "prn",
    ...
    def __init__(self):
        ...
        self.data_vector = []
        """
        Description: num_bytes sized array of raw subframe message collected by the sensor. The underlying type and shape of the data vector is given by satnav_msg_id
        Units: none
    ...
    def _encode_one(self, buf):
        ...
        buf.write(
            struct.pack(">%db" % self.num_bytes, *self.data_vector[: self.num_bytes])
        )
    ...
    def _decode_one(buf):
        ...
        self.data_vector = struct.unpack(
            ">%db" % self.num_bytes, buf.read(self.num_bytes)
        )
    ...
    def _get_hash_recursive(parents):
        if measurement_satnav_subframe in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if measurement_satnav_subframe._packed_fingerprint is None:
            measurement_satnav_subframe._packed_fingerprint = struct.pack(
                ">Q", measurement_satnav_subframe._get_hash_recursive([])
            )
    ...
    def get_hash(self):
        ...
        return struct.unpack(
            ">Q", measurement_satnav_subframe._get_packed_fingerprint()
        )[0]
