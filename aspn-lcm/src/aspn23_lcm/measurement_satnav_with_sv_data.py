...
class measurement_satnav_with_sv_data(object):
    ...
    __slots__ = [
        "icd_measurement_satnav_with_sv_data",
        "header",
        "time_of_validity",
        "receiver_clock_time",
        "num_signal_types",
    ...
    __typenames__ = [
        ...
        "aspn23_lcm.type_satnav_sv_data",
        "int16_t",
    ...
    def __init__(self):
        ...
        self.sv_data = []
        """
        Description: Array of satellite position, velocity, and clock information. These line up precisely with the obs, such that sv_data[N] is the satellite information for observations obs[N] for any valid N
        Units: none
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num_signals_tracked):
            assert (
                self.sv_data[i0]._get_packed_fingerprint()
                == aspn23_lcm.type_satnav_sv_data._get_packed_fingerprint()
            )
    ...
    def _get_hash_recursive(parents):
        if measurement_satnav_with_sv_data in parents:
            return 0
        ...
        tmphash = (
            ...
            + aspn23_lcm.type_satnav_sv_data._get_hash_recursive(newparents)
    ...
    def _get_packed_fingerprint():
        if measurement_satnav_with_sv_data._packed_fingerprint is None:
            measurement_satnav_with_sv_data._packed_fingerprint = struct.pack(
                ">Q", measurement_satnav_with_sv_data._get_hash_recursive([])
            )
    ...
    def get_hash(self):
        ...
        return struct.unpack(
            ">Q", measurement_satnav_with_sv_data._get_packed_fingerprint()
        )[0]
