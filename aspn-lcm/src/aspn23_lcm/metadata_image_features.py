...
class metadata_image_features(object):
    ...
    __slots__ = ["icd_metadata_image_features", "info", "keypoint_detector", "orientation_calculated", "descriptor_extractor", "is_bigendian", "descriptor_type", "descriptor_number_of_elements"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_metadataheader", "int8_t", "boolean", "int8_t", "boolean", "int8_t", "int32_t"]
    ...
    def __init__(self):
        ...
        by 'descriptor_size'. In conjunction with descriptor_type, these fields describe how that data
        should be interpreted. For example - descriptor_type UINT8: descriptor_number_of_elements ==
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x3a1668c8e2cbd67d+ aspn23_lcm.type_metadataheader._get_hash_recursive(newparents)) & 0xffffffffffffffff
