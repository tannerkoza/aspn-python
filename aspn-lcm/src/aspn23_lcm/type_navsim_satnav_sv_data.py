...
class type_navsim_satnav_sv_data(object):
    ...
    def __init__(self):
        self.icd_type_navsim_satnav_sv_data = 0
        """
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(type_navsim_satnav_sv_data._get_packed_fingerprint())
    ...
    def decode(data: bytes):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != type_navsim_satnav_sv_data._get_packed_fingerprint():
            raise ValueError("Decode error")
        return type_navsim_satnav_sv_data._decode_one(buf)
    ...
    def _get_packed_fingerprint():
        if type_navsim_satnav_sv_data._packed_fingerprint is None:
            type_navsim_satnav_sv_data._packed_fingerprint = struct.pack(">Q", type_navsim_satnav_sv_data._get_hash_recursive([]))
        return type_navsim_satnav_sv_data._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", type_navsim_satnav_sv_data._get_packed_fingerprint())[0]
