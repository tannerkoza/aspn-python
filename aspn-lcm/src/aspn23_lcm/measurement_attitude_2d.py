...
class measurement_attitude_2d(object):
    """
    Two-dimensional, local level, geographic attitude expressed in the locally level
    NED frame as a rotation about two axes as defined by the reference_frame.
    """

    __slots__ = [
        "icd_measurement_attitude_2d",
        "header",
        "time_of_validity",
        "reference_frame",
        "attitude2d",
    ...
    """ Local level, geographic attitude expressed in the locally level NED frame as a rotation about the E-axis followed by rotation about the N-axis. Positive rotation follows the right-hand rule. The third rotation in the NED-frame is unspecified and is not sensed. Use attitude_3d to report a sensed third dimension that is zero. See also NED coordinate frame definition for N, E, and D definitions. """
    REFERENCE_FRAME_ND = 1
    """ Local level, geographic attitude expressed in the locally level NED frame as a rotation about the D-axis followed by rotation about the N-axis. Positive rotation follows the right-hand rule. The third rotation in the NED-frame is unspecified and is not sensed. Use attitude_3d to report a sensed third dimension that is zero. See also NED coordinate frame definition for N, E, and D definitions. """
    REFERENCE_FRAME_ED = 2
    """ Local level, geographic attitude expressed in the locally level NED frame as a rotation about the D-axis followed by rotation about the E-axis. Positive rotation follows the right-hand rule. The third rotation in the NED-frame is unspecified and is not sensed. Use attitude_3d to report a sensed third dimension that is zero. See also NED coordinate frame definition for N, E, and D definitions. """
    ERROR_MODEL_NONE = 0
    ...
    def _get_hash_recursive(parents):
        if measurement_attitude_2d in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if measurement_attitude_2d._packed_fingerprint is None:
            measurement_attitude_2d._packed_fingerprint = struct.pack(
                ">Q", measurement_attitude_2d._get_hash_recursive([])
            )
