...
class metadata_GLONASS_ephemeris(object):
    """
    GLONASS Ephemeris describing GLONASS satellite locations. Definitions and usage
    are covered in GLONASS ICD L1,L2 - Edition 5.1 2008, Section 4.4.
    """

    __slots__ = [
        "icd_metadata_GLONASS_ephemeris",
        "info",
        "time_of_validity",
        "slot_number",
        "freq_o",
    ...
    def __init__(self):
        ...
        self.n_t = 0
        """
        Description: Calender number of day within 4 year interval starting at Jan 1 of a leap year Units: days
        LCM Type: int32_t
        """
        ...
        self.gamma_n = 0.0
        """
        Description: Relative Satellite frequency bias Units: s/s
        LCM Type: double
        """
    ...
    def _decode_one(buf):
        ...
        (
            ...
            self.sv_vel_z,
            self.sv_accel_z,
        ) = struct.unpack(">iiiddddddddddddd", buf.read(116))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if metadata_GLONASS_ephemeris in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if metadata_GLONASS_ephemeris._packed_fingerprint is None:
            metadata_GLONASS_ephemeris._packed_fingerprint = struct.pack(
                ">Q", metadata_GLONASS_ephemeris._get_hash_recursive([])
            )
    ...
    def get_hash(self):
        ...
        return struct.unpack(
            ">Q", metadata_GLONASS_ephemeris._get_packed_fingerprint()
        )[0]
