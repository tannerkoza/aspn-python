...
class measurement_angular_velocity_1d(object):
    """
    Measures the angular velocity about the sense-axis. The sense-axis is the sensor
    frame x-axis as defined in mounting.
    """

    __slots__ = [
        "icd_measurement_angular_velocity_1d",
        "header",
        "time_of_validity",
        "sensor_type",
        "obs",
    ...
    """ Angular velocity integrated over last measurement period expressed as delta rotation in radians. Variance units are radians^2. Time of validity is the end of integration period. Integration period is from previous measurement to the current measurement. """
    ...
    def _get_hash_recursive(parents):
        if measurement_angular_velocity_1d in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if measurement_angular_velocity_1d._packed_fingerprint is None:
            measurement_angular_velocity_1d._packed_fingerprint = struct.pack(
                ">Q", measurement_angular_velocity_1d._get_hash_recursive([])
            )
    ...
    def get_hash(self):
        ...
        return struct.unpack(
            ">Q", measurement_angular_velocity_1d._get_packed_fingerprint()
        )[0]
