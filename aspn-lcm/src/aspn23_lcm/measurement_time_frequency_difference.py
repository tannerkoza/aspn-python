...
class measurement_time_frequency_difference(object):
    """
    Time and frequency difference between two clocks or timing sources. This
    measurement requires both time and frequency to be provided.
    """

    __slots__ = [
        "icd_measurement_time_frequency_difference",
        "header",
        "time_of_validity",
    ...
    def __init__(self):
        ...
        """
        Description: Covariance information for the time/frequency measurement. Using zero-indexing, the [0,0] element has units of sec^2, the [1,1] element has units of Hertz^2, and the off-diagonal terms have units of sec*Hertz
        Units: various
        LCM Type: double[2][2]
        """
    ...
    def decode(data: bytes):
        ...
        if (
            buf.read(8)
            != measurement_time_frequency_difference._get_packed_fingerprint()
        ):
    ...
    def _decode_one(buf):
        ...
        self.icd_measurement_time_frequency_difference = struct.unpack(
            ">b", buf.read(1)
        )[0]
        ...
        (
            ...
            self.digits_of_precision,
            self.freq_diff,
        ) = struct.unpack(">ihhqihd", buf.read(30))
        self.covariance = []
        for i0 in range(2):
    ...
    def _get_hash_recursive(parents):
        if measurement_time_frequency_difference in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if measurement_time_frequency_difference._packed_fingerprint is None:
            measurement_time_frequency_difference._packed_fingerprint = struct.pack(
                ">Q", measurement_time_frequency_difference._get_hash_recursive([])
            )
    ...
    def get_hash(self):
        ...
        return struct.unpack(
            ">Q", measurement_time_frequency_difference._get_packed_fingerprint()
        )[0]
