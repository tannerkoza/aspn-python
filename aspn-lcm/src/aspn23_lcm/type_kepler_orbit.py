...
class type_kepler_orbit(object):
    ...
    def __init__(self):
        ...
        self.omega_0 = 0.0
        """
        Description: Longitude of ascending node of orbit plane at weekly epoch Units: rad
        LCM Type: double
        """
    ...
    def _decode_one(buf):
        ...
        (
            ...
            self.c_is,
            self.t_oe,
        ) = struct.unpack(">bdddddddddddddddd", buf.read(129))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if type_kepler_orbit in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if type_kepler_orbit._packed_fingerprint is None:
            type_kepler_orbit._packed_fingerprint = struct.pack(
                ">Q", type_kepler_orbit._get_hash_recursive([])
            )
