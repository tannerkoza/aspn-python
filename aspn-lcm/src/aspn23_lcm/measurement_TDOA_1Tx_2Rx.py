...
class measurement_TDOA_1Tx_2Rx(object):
    ...
    def __init__(self):
        ...
        self.obs = 0.0
        """
        Description: Time difference of arrival (in meters). Time difference of Tx signal's arrival time at Rx1 minus Tx signal's arrival time at the sensor. Positive obs indicates Tx arrived at Rx1 later than arriving at the sensor
        Units: m
        LCM Type: double
        """
    ...
    def _encode_one(self, buf):
        ...
        assert (
            self.tx_position_and_covariance._get_packed_fingerprint()
            == aspn23_lcm.type_remote_point._get_packed_fingerprint()
        )
        self.tx_position_and_covariance._encode_one(buf)
        assert (
            self.rx1_position_and_covariance._get_packed_fingerprint()
            == aspn23_lcm.type_remote_point._get_packed_fingerprint()
        )
    ...
    def _decode_one(buf):
        ...
        self.obs, self.variance, self.error_model, self.num_error_model_params = (
            struct.unpack(">ddbi", buf.read(21))
        )
    ...
    def _get_hash_recursive(parents):
        if measurement_TDOA_1Tx_2Rx in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if measurement_TDOA_1Tx_2Rx._packed_fingerprint is None:
            measurement_TDOA_1Tx_2Rx._packed_fingerprint = struct.pack(
                ">Q", measurement_TDOA_1Tx_2Rx._get_hash_recursive([])
            )
        return measurement_TDOA_1Tx_2Rx._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", measurement_TDOA_1Tx_2Rx._get_packed_fingerprint())[
            0
        ]
