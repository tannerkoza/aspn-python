...
class measurement_magnetic_field_magnitude(object):
    ...
    __slots__ = [
        "icd_measurement_magnetic_field_magnitude",
        "header",
        "time_of_validity",
        "field_strength",
        "variance",
    ...
    def decode(data: bytes):
        ...
        if (
            buf.read(8)
            != measurement_magnetic_field_magnitude._get_packed_fingerprint()
        ):
    ...
    def _decode_one(buf):
        ...
        self.icd_measurement_magnetic_field_magnitude = struct.unpack(
            ">b", buf.read(1)
        )[0]
    ...
    def _get_hash_recursive(parents):
        if measurement_magnetic_field_magnitude in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if measurement_magnetic_field_magnitude._packed_fingerprint is None:
            measurement_magnetic_field_magnitude._packed_fingerprint = struct.pack(
                ">Q", measurement_magnetic_field_magnitude._get_hash_recursive([])
            )
    ...
    def get_hash(self):
        ...
        return struct.unpack(
            ">Q", measurement_magnetic_field_magnitude._get_packed_fingerprint()
        )[0]
